const spooky_ipfs_images = {
  'Kings Home': 'https://ipfs.infura.io/ipfs/QmUDQPHPPhm5b6fX1y4o817drQVMgoWufBV6j4pz2wRYcJ',
  'Kings Classic': 'https://ipfs.infura.io/ipfs/QmWvDaEJ6cS4y3xoEahx8AMRQwnE1afAqrm5Zv3hn9urP3'
};
...
const FOLDER_NAME = 'kings_batch_1';
...
(async function () {
  ...
  /////////////////////////////////////////////////////////////////////////////////////
    ...
    await uploadToIpfs(require('./ipfs_data'));
  }
  ////////////////////////////////////////////
...
async function convertRawToIpfsPayload(data) {
  ...
  let rawIpfsData = data.map((values) => {
    const spookyIpfsImage = spooky_ipfs_images[values['colour']];
    if (!spookyIpfsImage) {
      throw new Error(`Missing image [${values['colour']}]`);
    }
    return {
      name: values['name'],
